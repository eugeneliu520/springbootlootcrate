 ...
 **/
public class LootCrateDeploySuccessEvent extends AbstractLootCrateEvent{

    public LootCrateDeploySuccessEvent(DeployContext deployContext, Object source, Duration timeTaken) {
