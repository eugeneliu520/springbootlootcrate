 ...
 **/
public class LootCrateDeployContainerInitSuccessEvent extends AbstractLootCrateEvent{

    public LootCrateDeployContainerInitSuccessEvent(DeployContext deployContext, Object source, Duration timeTaken) {
